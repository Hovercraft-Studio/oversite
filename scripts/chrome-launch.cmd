...
node run-chrome.mjs --chrome-path %CHROME_BASE_PATH% --url "http://localhost:3002/#^&wsURL=ws://localhost:3003/ws" --fullscreen true --location 10,10 --screen-num 2 --kill-before false
